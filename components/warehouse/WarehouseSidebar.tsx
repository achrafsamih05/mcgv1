...
import type { VerificationState, WarehouseSectionId } from "@/lib/warehouse/types";
...
export function WarehouseSidebar({
  ...
  active: WarehouseSectionId;
  onSelect: (id: WarehouseSectionId) => void;
  displayName: string;
      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-sm font-bold text-white">MCG <span className="text-accent-500">Storage</span></p>
              <p className="text-[11px] uppercase tracking-wider text-navy-400">Operator Console</p>
            </div>
          </div>
          <button
            type="button"
